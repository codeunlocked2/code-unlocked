    ...
    <>
      ...
      <main className='flex w-full flex-col items-center justify-center'>
        ...
        <div className='flex items-center justify-between w-full pt-1 lg:pt-1  lg:flex-col '>
          ...
          <div className='grid grid-cols-12 gap-16 xs:gap-4 lg:gap-8 gap-y-16 items-center justify-between  mt-32 xs:mt-16'>

            <div className='col-span-4 lg:col-span-6 md:col-span-6 xs:col-span-12  items-end justify-center dark:text-light  rounded-lg px-8 py-4 border-2 border-solid border-black dark:border-light hover:shadow-[5px_5px_0px_0px] dark:hover:shadow-[5px_5px_0px_0px_#fff] transition-all'> 
            ...
            <div className='col-span-4 lg:col-span-6 md:col-span-6 xs:col-span-12 items-end justify-center dark:text-light  rounded-lg px-8 py-4 border-2 border-solid border-black dark:border-light hover:shadow-[5px_5px_0px_0px] dark:hover:shadow-[5px_5px_0px_0px_#fff]transition-all cursor-pointer'> 
            ...
            <div className='col-span-4 lg:col-span-6 md:col-span-8 xs:col-span-12 items-end justify-center dark:text-light  rounded-lg px-8 py-4 border-2 border-solid border-black dark:border-light hover:shadow-[5px_5px_0px_0px] dark:hover:shadow-[5px_5px_0px_0px_#fff] transition-all cursor-pointer'> 
            <span className='inline-block text-7xl font-bold xl:text-5xl lg:text-5xl md:text-4xl sm:text-3xl'>
