...
const FeaturedUpdates = ({img, title, date, summary, link}) => {
    return(
        ...
        className='flex flex-col w-full mx-auto p-1 gap-6 bg-light dark:bg-dark  border border-solid border-dark dark:border-light rounded-md hover:shadow-[5px_5px_0px_0px] dark:hover:shadow-[5px_5px_0px_0px_#fff] transition-all'>
            ...
            <div className='p-4'>
                ...
                <Link href={link} target='_blank' className='hover:underline underline-offset-2 transition-all'>
                    <h1 className='my-2 w-full text-left dark:text-light text-3xl font-bold lg:text-2xl sm:text-xl line-clamp-1'> {title} </h1>
                </Link>
